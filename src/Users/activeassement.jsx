...
function Activeassement() {
  ...
  <NavbarUser/>
    ...
    <div className="row">
      ...
      <div className='scoll'>
      <div className="col-12 blogcard m-1 p-3">
        <div className="p-2">
          <div className="d-flex flex-column flex-md-row">
            ...
            <Link to="/Resumetext" style={{textDecoration:"none"}}><button className=" resume  btn btn-block">
                Resume Text
              </button></Link>
            </div>
          </div>
      ...
      <div className="col-12 blogcard m-1 p-3">
        <div className="p-2">
          <div className="d-flex flex-column flex-md-row">
            ...
            <div className="col-12 col-md-4"></div>
            <div className="m-2 col-12 col-md-4">
            <Link to="/Viewresult"style={{textDecoration:"none"}}><button className="  resume12 btn btn-block">
                View Result
              </button></Link>
            </div>
          </div>
