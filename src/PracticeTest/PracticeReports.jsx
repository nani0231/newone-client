...
function PracticeReport() {
	...
	const handleExportToExcel = () => {
		...
		XLSX.writeFileSync(wb, "PracticeReport.xlsx", {
			bookType: "xlsx",
			mimeType:
	...
	const handleCategorySelection = (e) => {
		...
		setFilteredCategoryData(result[0].Practicetopic);
	};
	return (
		<div>
								...
								<div className="">
									<div className="row">
										<div className="col-md-12 text-center">
											<h3 className="" style={{color:"#16c3ea"}}>Practice Participation Reports</h3>
										</div>
										<div className="col-md-6 mt-2">
											<label style={{fontWeight:"600"}}>
												Select Institution <sup className="star">*</sup>
											</label>
											<select
												name=""
												id=""
										...
										<div className="col-md-6 mt-2">
											<label style={{fontWeight:"600"}}>
												Select Category <sup className="star">*</sup>
											</label>
											<select
											...
											>
												...
												{categoryData.map((entry, index) => (
													<option key={index} value={entry._id} data-value={
														entry.name}>
														{entry.name}
													</option>
												))}
										...
										<div className="col-md-6 mt-2">
											<label style={{fontWeight:"600"}}>
												Select Topic <sup className="star">*</sup>
											</label>
											<select
											...
											>
												...
												{filteredCategoryData.map((entry, index) => (
													<option key={index} value={entry.topicName}>
														{entry.topicName}
													</option>
												))}
											</select>
										...
										<div className="col-md-6 mt-2">
											<label style={{fontWeight:"600"}}>
												Select Batch Year <sup className="star">*</sup>
											</label>
											<select
												name=""
												id=""
										...
										<div className="col-md-6 mt-2">
											<label style={{fontWeight:"600"}}>
											Select Batch <sup className="star">*</sup>
											</label>
											<select
												name=""
												id=""
										...
										<div className="text-center mt-4">
											<button className="btn12" style={{backgroundColor:"#16c3ea", color:"#000", borderRadius:"4px", padding:"8px"}} onClick={handleExportToExcel}>
												Export to Excel
											</button>
										</div>
									</div>
