																...
																<div className="row">
																	...
																	<div className="col-lg-6">
																		...
																		>
																			...
																			<option data-value="Banking">
																				Banking
																			</option>
																			<option data-value="Aptitude">
																				Aptitude
																			</option>
																			<option data-value="Biology">
																				Biology
																			</option>
																		</select>
																	</div>
																	<div className="col-lg-6">
																		...
																		<select
																			...
																			className="form-control mb-2"
																			// onChange={(e) => setSubjectTag(e.target.value)}
																			onChange={handleAccessTypeSelection}
																		>
																			<option value="">
																				Select accesstype
																			</option>
																	...
																	<div className="col-lg-6">
																		...
																		<select
																			...
																			className="form-control mb-2"
																			// onChange={(e) => setSubjectTag(e.target.value)}
																			onChange={handleAccessplanSelection}
																		>
																			<option value="">
																				Select accessplan
																			</option>
